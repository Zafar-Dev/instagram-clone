...
const Navbar = () => {
    const {postToggle, setPostToggle} = useContext(ModalContext)
    console.log(postToggle)
    return (
        <div className='container nav'>
            <nav className='navbar_container container__width'>
                ...
                <ul>
                    ...
                    <li className='nav_link'>
                        <Link to=""  onClick={() => setPostToggle(true)}>
                    ...
                    <li className='nav_link profile_link'>
